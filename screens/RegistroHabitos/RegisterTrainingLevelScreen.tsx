...
const RegisterTrainingLevelScreen = () => {
    ...
    try {
      ...
      if (!userDoc.exists()) {
        ...
        await setDoc(userRef, {
          niveles: arrayUnion({ nivel: selectedLevel, actividad: 'Entrenamiento', timestamp: new Date() }),
        });
      } else {
  ...
  return (
    <View className="flex-1 justify-center items-center bg-blue-500">
      ...
      <Text className="text-white text-lg mb-10">Actividad: Entrenamiento</Text>
...
export default RegisterTrainingLevelScreen;
