...
const App = () => {
  ...
  const [ejercicio, setEjercicio] = useState('Flexiones de brazos');
  ...
  const ejercicios = ['Flexiones de brazos', 'Press de banca', 'Dominadas', 'Elevacion de Hombros'];
  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      onSnapshot(userRef, async (userSnap) => {
        ...
        await guardarProgresoRutina('tren_superior', ejercicio, tiempoTotalTrabajo, calorias);
