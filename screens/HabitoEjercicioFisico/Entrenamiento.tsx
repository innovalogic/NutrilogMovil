...
const EntrenamientoScreen = () => {
    ...
    return (
        <View className="flex-1 bg-blue-200 items-center justify-center p-5">
            ...
            <TouchableOpacity className="bg-white rounded-lg p-4 mb-2 w-full shadow-md" onPress={() => handleNavigation('Yoga')}>
            ...
            <TouchableOpacity className="bg-white rounded-lg p-4 mb-2 w-full shadow-md" onPress={() => handleNavigation('Cardio')}>
